...
// This file is now primarily for mocked report data.
// Core data like companies, materials, waste logs, and events are now managed in Firebase Realtime Database.
