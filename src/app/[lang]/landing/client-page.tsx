            ...
            <main className="relative pt-28 sm:pt-32">
                <section className="relative">
                    <div className="absolute inset-0 -z-10 overflow-hidden rounded-b-[2rem]">
                        <Image src="https://firebasestorage.googleapis.com/v0/b/wastewise-hdbhk.firebasestorage.app/o/img.jpg?alt=media&token=ad081ca2-8ba5-4309-9d71-b5d409d1e07d" alt="Earth from space, sustainability" fill objectFit="cover" className="opacity-30" data-ai-hint="earth space sustainability" />
                        <div className="absolute inset-0 bg-gradient-to-b from-[#0B1020]/40 via-[#0B1020]/60 to-[#0B1020]" style={{ position: 'relative' }}></div>
                    </div>
                ...
                <section id="demo" className="mt-20">
                    <div className="container-responsive">
                        <div className="relative overflow-hidden rounded-3xl p-8 sm:p-12 ring-1 ring-white/10 bg-gradient-to-br from-[#0B1020] to-slate-900">
                         <Image src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" alt="Minimal 3D render background" fill objectFit="cover" className="absolute inset-0 opacity-10 -z-10" data-ai-hint="abstract background" />
